...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 02, 2018 at 06:20 AM
...
(80, 8, 'Dermatology', '19', '20', '2018-02-24 11:25:58', 'this istill tell', 1, 1, '2018-01-29', '2018-01-30', '12:00:00', '12:00:00'),
...
(8, 'Mohamed Isak', '615779523', 'Antartica', 'Antartica', 'districit', '30m Date of Birth', '2022-01-18', 'female', '2018-01-03 04:19:52', 1, 106, 1),
(9, 'Mahad Cigale', '615779523', 'Belarus', 'Homyel\'skaya (Homyel\')', 'dom varey', '30m souls', '2023-01-18', 'female', '2018-01-04 14:45:05', 1, 106, 1),
(10, 'Mo Siyaasi', '6157861666', 'Azerbaijan', 'Daskasan Rayonu', 'districit', '30m Date of Birth', '2022-01-18', 'male', '2018-01-06 19:33:34', 0, 106, 1),
(11, 'Mahad Maxamuud Cigale', '615779523', 'Somalia', 'Togdheer', 'districit', '30m, 30 wershadaha', '2018-01-07', 'female', '2018-01-12 13:06:59', 0, 106, 1),
(12, 'Saadaq Maxamuud Cigale', '612991211', 'Somalia', 'Banaadir', 'hodan', 'Sona -k', '1998-01-29', 'male', '2018-02-22 12:18:46', 0, 106, 1),
(13, 'Xasan Cabdi Xasan', '612881121', 'Bahamas', 'Nicholls Town and Berry Islands', 'hodan', 'sona k', '2018-02-12', 'female', '2018-02-24 11:37:48', 0, 106, 1),
(14, 'Xasan Cabdi Xasan', '612881121', 'Bahamas', 'Nicholls Town and Berry Islands', 'hodan', 'sona k', '2018-02-12', 'female', '2018-02-24 11:37:56', 0, 106, 1),
(15, 'Handiis Nashiid Maajid', '615779523', 'Argentina', 'Chaco', 'bistola', '30m, 30 wershadaha', '2018-02-06', 'male', '2018-02-24 13:45:07', 1, 106, 1);
...
INSERT INTO `permission` (`id`, `name`, `parent_id`, `level_id`, `sort`, `type_id`, `url`, `target`, `status_id`, `icon`, `event`) VALUES
...
INSERT INTO `prescription_detail` (`pd_id`, `prescription_id`, `medication_id`, `dosage`, `dosage_unit_id`, `frequency_id`, `duration`, `instruction`, `status_id`) VALUES
(14, 13, 34, '2', 1, 3, '1', 'Before Food', 1),
(15, 14, 34, '3', 1, 2, '4', 'After Food', 1),
(16, 15, 34, '3', 1, 4, '6', 'Before Food', 1),
(17, 16, 34, '2', 1, 3, '3', 'Before Food', 1),
(18, 17, 34, '2', 1, 4, '4', 'Before Food', 1),
(19, 18, 34, '7', 1, 2, '3', 'After Food', 1),
(20, 19, 34, NULL, 1, NULL, NULL, 'Before Food', 1),
(21, 20, 34, '4', 1, 2, '2', 'After Food', 1),
(22, 20, 35, '2', 1, 3, '3', 'After Food', 1),
(23, 21, 34, '3', 1, 4, '2', 'After Food', 1),
(24, 21, 35, '3', 1, 3, '1', 'After Food', 1),
(25, 21, 35, '4', 4, 5, '3', 'Before Food', 1),
(26, 22, 34, '2', 1, 5, '4', 'After Food', 1),
(27, 23, 40, '3', 2, 4, '2', 'After Food', 1);
...
INSERT INTO `prescription_list` (`pl_id`, `patient_id`, `doctor_id`, `status_id`, `date`, `company_id`) VALUES
(12, 1, 114, 1, '2017-10-05', 1),
(13, 1, 114, 1, '2017-10-05', 1),
(14, 1, 114, 1, '2017-10-06', 1),
(15, 1, 114, 1, '2017-10-06', 1),
(16, 1, 114, 1, '2017-10-06', 1),
(17, 1, 114, 1, '2017-10-06', 1),
(18, 3, 106, 1, '2017-10-20', 1),
(19, 2, 106, 1, '2017-10-29', 1),
(20, 2, 106, 1, '2017-10-29', 1),
(21, 2, 106, 1, '2017-10-29', 1),
(22, 5, 106, 1, '2017-11-02', 1),
(23, 6, 106, 1, '2017-12-14', 1);
...
INSERT INTO `roles` (`id`, `name`, `status_id`, `description`) VALUES
(1, 'Admin', 1, 'This is admin Board only admin Are allowed to access this permission'),
(2, 'Doctors Outh', 1, 'Doctors Outh means the doctors that have a doctor role and and Have system Authentication To Access inside system'),
(3, 'Staff', 1, 'Is like Nurse and other extra employee to the hospitals or health service'),
(10, 'Users', 1, 'this user that allow to access only permision maping'),
(11, 'Mode', 0, '0'),
(12, 'Test', 0, 'this test issue for description'),
(13, 'Bastro', 0, 'Wikas roy'),
(14, 'Pharmacist', 1, 'Pharmacist is a person that sells Drugs and medication in the hospitals after They prescription from a doctor and explain patients how the person will use it'),
(15, 'Managers', 1, 'Manager is of the top level directors of the hospital');
...
(32, 'Diabetes Screen (Glucose only)', '120', 'Item', 14, 'Please do not eat or drink anything except water for 8-12 hours before your test.', 'this', 'no', 1, 'Detects diabetes or a pre-diabetic condition.'),
...
(45, 'Knee pain', '10', 'Item', 43, 'this pain  more', 'this', 'yes', 1, 'this not resatable pain'),
...
INSERT INTO `test_order_detail` (`id`, `test_order_id`, `result`, `note`, `test_id`, `status_id`, `amount`) VALUES
(27, 15, NULL, NULL, 32, 2, '220'),
(28, 15, NULL, NULL, 38, 2, '10'),
(29, 16, NULL, NULL, 32, 2, '220'),
(30, 16, NULL, NULL, 42, 2, '10'),
(31, 17, NULL, NULL, 46, 2, '15'),
(32, 17, NULL, NULL, 44, 2, '20'),
(33, 18, NULL, NULL, 44, 2, '20'),
(34, 18, NULL, NULL, 45, 2, '10');
...
(16, 8, 1, 106, 17, '230', 2, '2018-02-24 14:00:23'),
(17, 8, 1, 106, 20, '35', 2, '2018-02-24 16:56:29'),
(18, 8, 1, 106, 18, '30', 2, '2018-03-22 14:27:43');
...
INSERT INTO `transactions` (`payment_id`, `patient_id`, `order_id`, `order_type`, `amount`, `discount`, `balance`, `status`, `date`, `account`, `trunsaction_type`, `company_id`) VALUES
(68, 2, 28, 'Test', '20', '0', '20', '2', '2017-11-14', '615779523', 'payment', 1),
(69, 2, 29, 'Test', '20', '0', '20', '2', '2017-11-15', '615779523', 'payment', 1),
(70, 2, 35, 'OrderPayment', '10', '0', '10', '2', '2017-11-15', '615553080', 'payment', 1),
(71, 2, 26, 'AppointPayment', '20', '0', '20', '2', '2017-11-15', '615553080', 'payment', 1),
(72, 2, 30, 'AppointPayment', '10', '0', '10', '2', '2017-11-15', '615779523', 'payment', 1),
(73, 2, 36, 'OrderPayment', '20', '0', '20', '2', '2017-11-15', '615553080', 'payment', 1),
(74, 2, 31, 'AppointPayment', '23', '0', '23', '2', '2017-11-15', '30575113', 'payment', 1),
(75, 6, 37, 'OrderPayment', '70', '20', '70', '2', '2017-12-14', '30575113', 'payment', 1),
(76, 2, 30, 'AppointPayment', '10', '0', '10', '2', '2018-01-11', '615760285', 'payment', 1),
(77, 2, 38, 'OrderPayment', '40', '0', '40', '2', '2018-02-04', '0030505212', 'payment', 1);
...
INSERT INTO `users` (`id`, `name`, `email`, `password`, `remember_token`, `status_id`, `default_language_id`, `company_id`, `mobile`, `phone`, `address`, `city`, `country`, `default_cash_account_id`, `permission_type`, `date`) VALUES
(106, 'Mahad Cigale', 'mahads@gmail.com', '$2y$10$jovh7NCFLvZFQ.DxYIW3PucHNjcqPiofeZaBKdEY75xMheh72cSnO', 'Yy9rQNiM8ikkLaPhAuzdQHuR1YTJlQpgXT1YK4Q0zJvj1Ejm9ZAhwaUDnXLh', 1, 1, 1, '615779523', '615779523', 'Warta nabad -30 m', 'Moqdisho', 'Somalia', 1, '', '0000-00-00'),
(107, 'Cabdi Xasan', 'mahad@gmail.com', '$2y$10$tTCkIQ0mfeu9Nm3EKg2oDeaLGl82bA2LAIOO7YcUvEY3AkVic9P1i', 'fj5KX98MC0Lu8yzhmY3eVu7WZxLKUcUUpMXUC6s6', 1, 1, 1, '612999211', '612999211', 'Anticas 3', 'Antartica', 'Antartica', 1, '1', '2017-12-11'),
(109, 'Maxamed Jamac', 'mahadsos@gmail.com', '$2y$10$6qMiv63hM1TKRtCqE.aPeegFhkavRGTe8/ZKMeXFYTD/gqGC363Vq', 'fj5KX98MC0Lu8yzhmY3eVu7WZxLKUcUUpMXUC6s6', 1, 1, 1, '6612316611', '6612316611', 'Hodan', 'Durres', 'Albania', 1, '1', '2017-12-11'),
(110, 'Maxamed Jamac', 'mahadsos@gmail.com', '$2y$10$2q0qlMAOFap9A7IL1JYDguLIAaH/xBzjUpH9ma9Av4z1wvtAxdpz2', 'fj5KX98MC0Lu8yzhmY3eVu7WZxLKUcUUpMXUC6s6', 1, 1, 1, '6612316611', '6612316611', 'Hodan', 'Durres', 'Albania', 1, '1', '2017-12-11'),
(111, 'Ms Barcas', 'mahadses@gmail.com', '$2y$10$SBGYkF/t7i1TJLt28MiBmujdwETwhFvpNkfrgjhfNu1v/tv/SdcTG', 'fj5KX98MC0Lu8yzhmY3eVu7WZxLKUcUUpMXUC6s6', 1, 1, 1, '631631112', '631631112', 'sasom adrss', 'Fier', 'Albania', 1, '1', '2017-12-11'),
(112, 'Dr Cabdi Xaashi', 'drxaasho@gmail.com', '$2y$10$pjv0MECD8YO8ffbA8ETo3uRjf/KfQHY89i8CIPMA8KGkZiD/5cxt6', 'fj5KX98MC0Lu8yzhmY3eVu7WZxLKUcUUpMXUC6s6', 1, 1, 1, '626126131', '626126131', 'Trust warn', 'Adrar', 'Algeria', 1, '2', '2017-12-11'),
(113, 'Dr Mo Xasan', 'mahadse@gmail.com', '$2y$10$tWAGnw3GHMuunL7FhipkoO21FD2nKfRs7FsAZGJp6YwaljPV/huhu', 'fj5KX98MC0Lu8yzhmY3eVu7WZxLKUcUUpMXUC6s6', 1, 1, 1, '6121666121', '6121666121', 'Hodan', 'Cabinda', 'Angola', 1, '1', '2017-12-11'),
(114, 'Dr Jr Delson', 'mahadsandes@gmail.com', '$2y$10$A1TMZgqd2aYDJnizT.Myq.p2yu1iW1PQ5fEwoa3zbm2ozihK9zMR.', 'fj5KX98MC0Lu8yzhmY3eVu7WZxLKUcUUpMXUC6s6', 1, 1, 1, '662161112', '662161112', 'Sandes be', 'Delvine', 'Albania', 1, '1', '2017-12-11'),
(115, 'Dr Jr Delson', 'mahadsandes@gmail.com', '$2y$10$s2zHbZha6rldi786wNoV6.DXvhOg.JmyzGEDZB.4cTukbdLxuruNC', 'fj5KX98MC0Lu8yzhmY3eVu7WZxLKUcUUpMXUC6s6', 1, 1, 1, '662161112', '662161112', 'Sandes be', 'Delvine', 'Albania', 1, '1', '2017-12-11'),
(116, 'Dr Xamadi Xasan Cabdi', NULL, '$2y$10$dJTmDnqnBboNwbln.Ha.RO79wJ9j3z2lJtyVRS6.BQtnzZkf4CfzK', 'zNGjmEY1UdLnc5kiRO6cpUTG7FQTl1nfk3CkMxGG4DWajbSvuF1k08hkoMgz', 1, 1, 1, '+6126662161', '+6126662161', 'gtewetw', 'Antartica', 'Antartica', 1, '1', '2017-12-20'),
(117, 'Cabdi Wahab', 'abdiwahab@gmail.com', '$2y$10$.BRTgawUxR5tt33fuuVqyeLIev5RyuU/3ih.VQwIeOmbhmiUElJc6', '6WaNMfy8XzZIfWmVLx0g3PWVEbMaMUK2K3RWmw0W', 1, 1, 1, '615779523', '615779523', '30m, 30 wershadaha', 'Anguilla', 'Anguilla', 1, '1', '2017-12-20'),
(118, 'Cabdi Wahab', 'abdiwahab@gmail.com', '$2y$10$IZoiQgybfUKfPdG7sbCkV.Ur4e/0PN58MEzLTh2i/nZ52Z7hZxl3C', '6WaNMfy8XzZIfWmVLx0g3PWVEbMaMUK2K3RWmw0W', 1, 1, 1, '615779523', '615779523', '30m, 30 wershadaha', 'Anguilla', 'Anguilla', 1, '1', '2017-12-20');
...
INSERT INTO `user_role_maping` (`id`, `user_id`, `role_id`, `status_id`) VALUES
(42, 109, 1, 1),
(43, 109, 2, 1),
(44, 110, 1, 1),
(45, 110, 2, 1),
...
--
ALTER TABLE `prescription_list`
  MODIFY `pl_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
