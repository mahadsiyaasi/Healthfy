          ...
          @endif
                  ...
                  <div class="w3-white w3-padding" style="width: 100%; position: relative;">
                      ...
                      <div class="navbar-right w3-padding">
                        ...
                        <button class="w3-button w3-teal w3-text-white w3-hover" style="display: inline-block; position: relative; right: -5px; bottom: -2.5px" id="savepatient" onclick="savepatient(this)">Save</button>
