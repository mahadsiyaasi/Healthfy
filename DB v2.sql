...
--
ALTER TABLE `permission_maping`
  ADD CONSTRAINT `permission_maping_ibfk_1` FOREIGN KEY (`entity_id`) REFERENCES `roles` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `permission_maping_ibfk_2` FOREIGN KEY (`permission_id`) REFERENCES `permission` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
